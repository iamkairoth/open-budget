  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-20">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">The Manual</h1>
        ...
        <div className="flex justify-center mt-6">
          <div className="bg-white p-1 rounded-xl shadow-sm border border-slate-200 inline-flex flex-wrap gap-1 justify-center">
            {[
      ...
      {activeTab === 'system' && (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
          ...
          {/* Section 1: Salary */}
          <div className="grid md:grid-cols-12 gap-8 items-center bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
             <div className="md:col-span-4 flex flex-col items-center text-center">
                ...
                <h2 className="text-2xl font-bold text-slate-800">Salary Architect</h2>
             ...
             <div className="md:col-span-8 space-y-4">
                ...
                <div className="bg-slate-50 rounded-xl p-5 border border-slate-100 space-y-3">
                   <h3 className="font-bold text-slate-800 text-sm uppercase tracking-wide">💡 Pro Tips</h3>
          ...
          <div className="grid md:grid-cols-12 gap-8 items-center bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
             <div className="md:col-span-4 flex flex-col items-center text-center">
                ...
                <h2 className="text-2xl font-bold text-slate-800">The Budget</h2>
             ...
             <div className="md:col-span-8 space-y-4">
                ...
                <div className="bg-slate-50 rounded-xl p-5 border border-slate-100 space-y-3">
                   <h3 className="font-bold text-slate-800 text-sm uppercase tracking-wide">💡 Key Rules</h3>
                   <ul className="space-y-2 text-sm text-slate-600">
                      <li className="flex gap-2 items-start">
      ...
      {activeTab === 'automation' && (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
           ...
           <div className="bg-blue-50 border border-blue-200 p-6 rounded-2xl text-center max-w-3xl mx-auto">
              <h2 className="text-xl font-bold text-blue-900">Your Personal Automation Flow</h2>
              <p className="text-blue-700 text-sm mt-2">
                This diagram pulls real numbers from your <strong>Budget</strong>. <br/>
              ...
              <div className="min-w-[800px] flex flex-col items-center">
                 ...
                 <div className="grid grid-cols-4 gap-6 w-full relative">
                    ...
                    <div className="pt-8 flex flex-col items-center">
                       ...
                       <div className="bg-white p-5 rounded-xl border-t-4 border-red-400 shadow-lg w-full text-center h-full">
                          <div className="text-[10px] font-bold uppercase text-slate-400">Date: 1st-3rd</div>
                          <div className="font-bold text-slate-800 text-lg">Fixed Costs</div>
                          <div className="text-red-500 font-mono font-bold text-xl mt-1">{currency}{alloc.fixed.toLocaleString()}</div>
                          <div className="mt-4 text-left bg-slate-50 p-3 rounded-lg text-xs space-y-2">
                             <p className="font-bold text-slate-700">Where to put it?</p>
                             <ul className="list-disc list-inside text-slate-500">
                                <li>Keep in Checking</li>
                                <li>Set Bills to Auto-Pay</li>
                             </ul>
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="pt-8 flex flex-col items-center">
                       <div className="h-6 w-0.5 bg-slate-300 mb-2"></div>
                       <div className="bg-white p-5 rounded-xl border-t-4 border-green-400 shadow-lg w-full text-center h-full">
                          <div className="text-[10px] font-bold uppercase text-slate-400">Date: 5th</div>
                          <div className="font-bold text-slate-800 text-lg">Investments</div>
                          <div className="text-green-600 font-mono font-bold text-xl mt-1">{currency}{alloc.invest.toLocaleString()}</div>
                          <div className="mt-4 text-left bg-slate-50 p-3 rounded-lg text-xs space-y-2">
                             <p className="font-bold text-slate-700">Where to put it?</p>
                             <ul className="list-disc list-inside text-slate-500">
                                <li>401k / Roth IRA</li>
                                <li>Index Funds</li>
                                <li>Set Auto-Transfer</li>
                             </ul>
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="pt-8 flex flex-col items-center">
                       <div className="h-6 w-0.5 bg-slate-300 mb-2"></div>
                       <div className="bg-white p-5 rounded-xl border-t-4 border-blue-400 shadow-lg w-full text-center h-full">
                          <div className="text-[10px] font-bold uppercase text-slate-400">Date: 5th</div>
                          <div className="font-bold text-slate-800 text-lg">Savings</div>
                          <div className="text-blue-500 font-mono font-bold text-xl mt-1">{currency}{alloc.savings.toLocaleString()}</div>
                          <div className="mt-4 text-left bg-slate-50 p-3 rounded-lg text-xs space-y-2">
                             <p className="font-bold text-slate-700">Where to put it?</p>
                             <ul className="list-disc list-inside text-slate-500">
                                <li>High Yield Savings</li>
                                <li>FDs / Liquid Funds</li>
                             </ul>
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="pt-8 flex flex-col items-center">
                       <div className="h-6 w-0.5 bg-slate-300 mb-2"></div>
                       <div className="bg-white p-5 rounded-xl border-t-4 border-purple-400 shadow-lg w-full text-center h-full">
                          <div className="text-[10px] font-bold uppercase text-slate-400">Date: Anytime</div>
                          <div className="font-bold text-slate-800 text-lg">Guilt-Free</div>
                          <div className="text-purple-500 font-mono font-bold text-xl mt-1">{currency}{alloc.guiltFree.toLocaleString()}</div>
                          <div className="mt-4 text-left bg-slate-50 p-3 rounded-lg text-xs space-y-2">
                             <p className="font-bold text-slate-700">Where to put it?</p>
                             <ul className="list-disc list-inside text-slate-500">
                                <li>Keep in Checking</li>
                                <li>Or Separate Debit Card</li>
                             </ul>
                          </div>
                       </div>
                    </div>
      ...
      {activeTab === 'vision' && (
        <div className="max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 space-y-8">
           ...
           <div className="text-center">
              <h2 className="text-2xl font-bold text-slate-800">Your Rich Life Profile</h2>
           ...
           <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden group focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all">
                 ...
                 <label className="block font-bold text-lg text-slate-800 mb-2 relative z-10">
                 ...
                 <p className="text-sm text-slate-500 mb-4 relative z-10">
                    ...
                    <em> (e.g., "I buy appetizers without looking at the price.")</em>
                 </p>
                 <textarea 
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden group focus-within:ring-2 focus-within:ring-red-500/20 transition-all">
                 ...
                 <p className="text-sm text-slate-500 mb-4 relative z-10">
                    ...
                    <em> (e.g., "I drive a 10-year old car" or "I never buy brand name clothes.")</em>
                 </p>
                 <textarea 
              ...
              <div className="bg-slate-900 text-white p-8 rounded-2xl shadow-xl text-center">
                 <h3 className="text-xl font-bold mb-4">Your Rich Life Statement</h3>
                 <p className="text-slate-400 text-sm mb-6">
                    Combine them into one sentence. This is your compass.
                 </p>
                 <div className="relative">
                    <span className="absolute top-3 left-3 text-slate-500 font-serif text-4xl">“</span>
                    <textarea 
                        className="w-full p-6 bg-slate-800 rounded-xl border border-slate-700 focus:border-indigo-500 outline-none transition-all min-h-[120px] text-center text-lg font-medium leading-relaxed italic"
                        placeholder="I live my Rich Life by..."
                        value={vision.statement}
                        onChange={(e) => setVision({...vision, statement: e.target.value})}
                    />
                    <span className="absolute bottom-3 right-3 text-slate-500 font-serif text-4xl">”</span>
                 </div>
                 
                 <button 
                    onClick={saveVision}
                    className="mt-6 px-8 py-3 bg-indigo-500 hover:bg-indigo-400 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/30 transition-all active:scale-95"
                 >
                    Save My Vision
                 </button>
              </div>
      ...
      {activeTab === 'library' && (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200">
             <h2 className="text-2xl font-bold text-slate-800 mb-6">Common Terms Defined</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
             <div className="bg-red-50 p-6 rounded-2xl border border-red-100">
                 <h3 className="font-bold text-red-800 mb-4 flex items-center gap-2">Debt Attack Plan</h3>
             ...
             <div className="bg-green-50 p-6 rounded-2xl border border-green-100">
                 <h3 className="font-bold text-green-800 mb-4 flex items-center gap-2">Wealth Setup</h3>
                 <ul className="space-y-3">
